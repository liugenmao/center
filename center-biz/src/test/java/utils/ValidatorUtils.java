...
public class ValidatorUtils {
	...
	public static boolean isEmpty( Object obj ) {
		if ( obj == null ) {
			return true;
		} else if ( obj instanceof CharSequence && ( obj.equals ( "" ) ) || obj.equals ( "null" ) ) {
			return true;
	...
	public static boolean isEmail( CharSequence val ) {
		Pattern pattern = Pattern.compile ( "^" + ANY_CHAR_EXPRESSION + "+(\\." + ANY_CHAR_EXPRESSION + "+)*@(" + DOMAIN_EXPRESSION + ")$",
